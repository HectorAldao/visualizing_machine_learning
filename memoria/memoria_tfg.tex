...
\usepackage{tikz}        % permite crear diagramas vectoriales dentro del documento
...
\begin{document}
 ...
 %\blindtext                % substitúe este comando polo teu texto de agradecementos
  A mi familia por el apoyo infinito, a Bombardeen por la compañía y las risas, y a Las Damas por el tiempo y el cariño.
 \end{agradecementos}
 ...
 \include{contido/1_introducion}
 \include{contido/2_sota}
 \include{contido/3_herramientas_y_tecnicas}
 \include{contido/4_metodologia_y_planificacion}
 \include{contido/4_5_marco_teorico}
 \include{contido/5_desarrollo}
 \include{contido/6_conclusions}
 %\include{contido/7_trabajo_futuro.tex}
