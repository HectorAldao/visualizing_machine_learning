...
badd +127 scenes/objects/nn/dense_conection_container/dense_conection_container.gd
...
badd +0 scenes/objects/nn/nn/neural_network_logical.gd
argglobal
%argdel
...
silent! normal! zE
let &fdl = &fdl
let s:l = 127 - ((44 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 127
...
silent! normal! zE
let &fdl = &fdl
let s:l = 96 - ((44 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 96
